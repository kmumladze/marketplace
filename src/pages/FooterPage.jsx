...
export default function FooterPage() {
  return (
    <>
      <footer className="bg-neutral-950 border-t border-gray-500 text-white py-10 px-6">
          ...
          <div>
            ...
            <form>
              <div className="flex flex-col gap-2">
                ...
                />
                <button className="bg-gray-800 px-4 py-2 rounded-md text-white hover:bg-gray-700">
                  Subscribe
                </button>
              </div>
            </form>
